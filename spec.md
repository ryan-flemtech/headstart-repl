...
Scratch: starter/complete tabs with separate workspace state, sprite manager, backdrop manager, toolbox XML editor, and copying tested complete/stage sprite presentation state into starter defaults.
